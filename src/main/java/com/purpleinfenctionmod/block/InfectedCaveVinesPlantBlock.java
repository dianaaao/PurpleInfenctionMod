...
public class InfectedCaveVinesPlantBlock extends CaveVinesBodyBlock {

    public InfectedCaveVinesPlantBlock(AbstractBlock.Settings settings) {
        super(settings);
    }

    @Override
    protected AbstractPlantStemBlock getStem() {
        return ModBlocks.INFECTED_CAVE_VINES;
    }
